...
cd "/home/tangy-user/groovy_ws/src/baxter_examples"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/tangy-user/groovy_ws/src/baxter_examples/setup.py" \
    build --build-base "/home/tangy-user/groovy_ws/build/baxter_examples" \
    install \
    $DESTDIR_ARG \

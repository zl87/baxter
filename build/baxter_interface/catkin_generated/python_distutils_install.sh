...
cd "/home/tangy-user/groovy_ws/src/baxter_interface"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/tangy-user/groovy_ws/src/baxter_interface/setup.py" \
    build --build-base "/home/tangy-user/groovy_ws/build/baxter_interface" \
    install \
    $DESTDIR_ARG \
